programa
{	/*Faça um programa que preencha três vetores com dez posições cada um: o primeiro vetor, com os nomes de
	dez produtos; o segundo vetor, com os códigos dos dez produtos; e o terceiro vetor, com os preços dos 
	produtos. Mostre um relatório apenas com o nome, o código, o preço e o novo preço dos produtos que sofrerão
	aumento.
	...
	funcao inicio()
	{
		...
		para(inteiro i=0; i<tam;i++){
			...
			se(produtosCodigo[i]%2==0 e produtosPreco[i]>1000){
				escreva("\nNovo valor "+produtosPreco[i]*1.20)
